...
@implementation twentyfiveDiagonalLockdown

+(CCScene *) scene {
	CCScene *scene = [CCScene node];
	
	twentyfiveDiagonalLockdown *layer = [twentyfiveDiagonalLockdown node];
...
-(void) checkCounted{
    ...
    *tmpT5, *tmpT6, *tmpT7, *tmpT8;
    
    //Check pos2500
    t = [tiles objectAtIndex:0];
    tmpT1 = [tiles objectAtIndex:6];
    tmpT2 = [tiles objectAtIndex:12];
    tmpT3 = [tiles objectAtIndex:18];
    tmpT4 = [tiles objectAtIndex:24];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)){
        t.counted = YES;
        numberCounted++;
    }
    else {
    ...
    tmpT1 = [tiles objectAtIndex:8];
    tmpT2 = [tiles objectAtIndex:12];
    tmpT3 = [tiles objectAtIndex:16];
    tmpT4 = [tiles objectAtIndex:20];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)){
    ...
    tmpT2 = [tiles objectAtIndex:11];
    tmpT3 = [tiles objectAtIndex:17];
    tmpT4 = [tiles objectAtIndex:23];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)){
    ...
    tmpT5 = [tiles objectAtIndex:18];
    tmpT6 = [tiles objectAtIndex:24];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)||
       (t.value + tmpT5.value == 25)||
       (t.value + tmpT6.value == 25)){
        t.counted = YES;
        numberCounted++;
    }
    else {
    ...
    tmpT4 = [tiles objectAtIndex:14];
    tmpT5 = [tiles objectAtIndex:16];
    tmpT6 = [tiles objectAtIndex:20];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)||
    ...
    tmpT2 = [tiles objectAtIndex:13];
    tmpT3 = [tiles objectAtIndex:17];
    tmpT4 = [tiles objectAtIndex:21];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)){
    ...
    tmpT4 = [tiles objectAtIndex:15];
    tmpT5 = [tiles objectAtIndex:17];
    tmpT6 = [tiles objectAtIndex:23];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)||
    ...
    tmpT4 = [tiles objectAtIndex:8];
    tmpT5 = [tiles objectAtIndex:16];
    tmpT6 = [tiles objectAtIndex:18];
    tmpT7 = [tiles objectAtIndex:20];
    tmpT8 = [tiles objectAtIndex:24];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)||
       (t.value + tmpT5.value == 25)||
       (t.value + tmpT6.value == 25)||
       (t.value + tmpT7.value == 25)||
       (t.value + tmpT8.value == 25)){
        t.counted = YES;
        numberCounted++;
    }
    else {
    ...
    tmpT4 = [tiles objectAtIndex:17];
    tmpT5 = [tiles objectAtIndex:19];
    tmpT6 = [tiles objectAtIndex:21];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)||
    ...
    //Check pos2516
    t = [tiles objectAtIndex:16];
    tmpT1 = [tiles objectAtIndex:4];
    tmpT2 = [tiles objectAtIndex:8];
    tmpT3 = [tiles objectAtIndex:10];
    tmpT4 = [tiles objectAtIndex:12];
    tmpT5 = [tiles objectAtIndex:20];
    tmpT6 = [tiles objectAtIndex:22];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)||
    ...
    //Check pos2517
    t = [tiles objectAtIndex:17];
    tmpT1 = [tiles objectAtIndex:5];
    tmpT2 = [tiles objectAtIndex:9];
    tmpT3 = [tiles objectAtIndex:11];
    tmpT4 = [tiles objectAtIndex:13];
    tmpT5 = [tiles objectAtIndex:21];
    tmpT6 = [tiles objectAtIndex:23];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
    ...
    //Check pos2518
    t = [tiles objectAtIndex:18];
    tmpT1 = [tiles objectAtIndex:0];
    tmpT2 = [tiles objectAtIndex:6];
    tmpT3 = [tiles objectAtIndex:12];
    tmpT4 = [tiles objectAtIndex:14];
    tmpT5 = [tiles objectAtIndex:22];
    tmpT6 = [tiles objectAtIndex:24];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
    ...
    //Check pos2520
    t = [tiles objectAtIndex:20];
    tmpT1 = [tiles objectAtIndex:4];
    tmpT2 = [tiles objectAtIndex:8];
    tmpT3 = [tiles objectAtIndex:12];
    tmpT4 = [tiles objectAtIndex:16];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)){
    ...
    //Check pos2521
    t = [tiles objectAtIndex:21];
    tmpT1 = [tiles objectAtIndex:9];
    tmpT2 = [tiles objectAtIndex:13];
    ...
    //Check pos2522
    t = [tiles objectAtIndex:22];
    tmpT1 = [tiles objectAtIndex:10];
    tmpT2 = [tiles objectAtIndex:14];
    tmpT3 = [tiles objectAtIndex:16];
    tmpT4 = [tiles objectAtIndex:18];
    if((t.value + tmpT1.value == 25)||
       (t.value + tmpT2.value == 25)||
       (t.value + tmpT3.value == 25)||
       (t.value + tmpT4.value == 25)){
