...
@implementation twentyfiveClassicLockdown

+(CCScene *) scene {
	CCScene *scene = [CCScene node];
	
	twentyfiveClassicLockdown *layer = [twentyfiveClassicLockdown node];
