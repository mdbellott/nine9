...
@implementation nineDiagonalLockdown

+(CCScene *) scene {
	CCScene *scene = [CCScene node];
	
	nineDiagonalLockdown *layer = [nineDiagonalLockdown node];
...
-(void) checkCounted{
    ...
    if((t.value + tmpT1.value == 9)||
       (t.value + tmpT2.value == 9)){
        t.counted = YES;
        numberCounted++;
    }
    else {
    ...
    if((t.value + tmpT1.value == 9)||
       (t.value + tmpT2.value == 9)||
       (t.value + tmpT3.value == 9)||
       (t.value + tmpT4.value == 9)){
        t.counted = YES;
        numberCounted++;
    }
    else {
