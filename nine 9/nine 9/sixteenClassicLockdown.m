...
@implementation sixteenClassicLockdown

+(CCScene *) scene {
	CCScene *scene = [CCScene node];
	
	sixteenClassicLockdown *layer = [sixteenClassicLockdown node];
...
-(id) init {
    if( (self=[super init])) {
        ...
        t1608no = [[CCTextureCache sharedTextureCache] addImage: @"tile1608.png"];
        ...
        t1608yes = [[CCTextureCache sharedTextureCache] addImage:@"tile1608Counted.png"];
